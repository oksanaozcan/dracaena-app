...
<form wire:submit.prevent="submitForm" class="px-6 pb-2 mb-4">
    ...
    <button
        type="submit"
        class="absolute inline-flex items-center px-8 py-2 font-semibold leading-6 text-white transition duration-150 ease-in-out rounded-md shadow cursor-not-allowed right-12 sm bg-cyan-700 hover:bg-cyan-900">
