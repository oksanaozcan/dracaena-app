...
<div class="mt-4 mb-6">
    ...
    >
    <div class="h-2">
        @error('name') <span class="h-full text-sm text-red-600 dark:text-red-500">{{ $message }}</span> @enderror
    </div>
</div>
...
<div class="mt-4 mb-6">
    ...
    >
    <div class="h-2">
        @error('email') <span class="h-full text-sm text-red-600 dark:text-red-500">{{ $message }}</span> @enderror
    </div>
</div>
